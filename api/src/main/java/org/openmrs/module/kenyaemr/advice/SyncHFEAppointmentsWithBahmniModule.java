...
public class SyncHFEAppointmentsWithBahmniModule implements AfterReturningAdvice {
    ...
    public void afterReturning(Object returnValue, Method method, Object[] args, Object target) throws Throwable {
        ...
        boolean followUpAppointment = false; //TODO: is this the clinical visit?
        boolean nxtAppointment = false;//TODO: what exactly is this?
        ...
        if (method.getName().equals("saveEncounter")) { // handles both create and edit
            ...
            if(enc.getVoided() == true && editAppointment != null && enc.getForm() != null) {
                ...
                Appointment drugRefillAppointment = hivFollowUpAppointment.getRelatedAppointment(); //TODO: will all refill appointments be related to the HIV follow up's?
                ...
                int hivFollowUpAppointmentConceptId = 160523;
                int hivDrugRefillAppointmentConceptId = 160521;
                if (editAppointment != null && enc.getForm() != null &&
                    ...
                    for (Obs o : obs) { // Loop through the obs and compose Appointment object for Bahmni
                        if((o.getConcept().getUuid().equals(APPOINTMENT_REASON_CONCEPT_UUID)) && hivFollowUpAppointment != null ) {
                            if(o.getValueCoded().getConceptId() == hivFollowUpAppointmentConceptId || o.getValueCoded().getConceptId() == hivDrugRefillAppointmentConceptId) {
